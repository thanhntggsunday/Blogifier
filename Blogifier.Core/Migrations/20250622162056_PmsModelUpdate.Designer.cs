...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blogifier.Core.Entities.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogifier.Core.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogifier.Core.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Blogifier.Core.Entities.CartItem", b =>
                {
                    b.HasOne("Blogifier.Core.Entities.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Blogifier.Core.Entities.OrderItem", b =>
                {
                    b.HasOne("Blogifier.Core.Entities.Order", "Order")
                        .WithMany("Items")
