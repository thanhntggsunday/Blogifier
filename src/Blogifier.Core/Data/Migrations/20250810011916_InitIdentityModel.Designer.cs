...
namespace Blogifier.Core.Data.Migrations
{
    ...
    [Migration("20250810011916_InitIdentityModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blogifier.Shared.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Blogifier.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Blogifier.Shared.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Blogifier.Shared.UserRole", b =>
                {
                    b.HasOne("Blogifier.Shared.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blogifier.Shared.User", "User")
                        .WithMany("UserRoles")
